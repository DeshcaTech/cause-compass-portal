...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-[14px] leading-[20px] font-medium cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        sm: "h-8 rounded-md px-3 text-[12px] leading-[16px]",
        lg: "h-10 rounded-md px-8",
        xl: "h-12 rounded-xl px-8 text-[16px] leading-[24px]",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
